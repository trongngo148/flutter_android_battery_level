...
class MyMessage {
  ...
  static MyMessage decode(Object message) {
...
class MessageApi {
  ...
  Future<List<MyMessage?>> getMessage(String arg_fromEmail) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.MessageApi.getMessage', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_fromEmail]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      ...
      return (replyMap['result'] as List<Object?>?)!.cast<MyMessage?>();
    }
  }
}
